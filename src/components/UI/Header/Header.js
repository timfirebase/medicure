            ...
            <Container>
                ...
                <Navbar.Collapse id="responsive-navbar-nav">
                    ...
                    }
                    {
                        ...
                        <Nav className="align-items-center">
                            <Nav.Link>
                                <img src={user.img || placeholder} alt={"img"} className="rounded-circle img-fluid" style={{width:'75px', height:'68px',marginRight:'10px'}}/>
                                <span className="text-white h5" style={{fontSize:'0.9rem'}}>{user.name} ({user.role})</span>
                            </Nav.Link>
